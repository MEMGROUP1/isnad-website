...
import { BurgerMenuIcon, EmailIcon, FacebookIcon, InstagramIcon, LinkedInIcon, PlanetIcon, WhatsappIcon, XIcon } from "@/assets/icons";
        ...
        <>
            ...
            {open &&
                ReactDOM.createPortal(
                    <div className="fixed inset-0 z-9999 flex flex-col bg-[#162032]/95 backdrop-blur-xl animate-in slide-in-from-right-10 fade-in duration-300">
                        {/* Header */}
                        <div className="flex flex-row-reverse items-center justify-between p-6">
                            <div className="flex items-center gap-4">
                                <Image src={Logo} alt="Logo" className="h-10 w-auto" />
                            </div>
                            <button onClick={() => setOpen(false)} className="flex items-center gap-2 text-white/80 hover:text-white transition-colors group">
                        ...
                        <div className="flex px-6 my-14">
                            <button className="group flex items-center justify-between gap-4 text-lg md:text-xl font-normal transition-all w-full" onClick={toggleLanguage}>
                        ...
                        <div className="px-6 w-full">
                            <Button variant={"white"} className="rounded-full h-full px-6 py-2.5 w-full">
                                {t("contact")}
                            </Button>
                        </div>

        ...
        <Section.Outer className="h-auto">
            <Section className="flex items-stretch *:flex-1 gap-10 py-16 h-auto">
                <div className="flex flex-col">
                    ...
                    <Image width={636} height={355} src={"/images/home/about/about-bg.png"} alt={""} className="object-cover mt-12 h-88.75" />
                </div>

                <div className="grid grid-cols-2 *:border border-[#C573405C]">
                    {cards.map((card, index) => (
                        <article key={card.label + index} className={card.className + " p-8 flex flex-col justify-end"}>

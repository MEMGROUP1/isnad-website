...
export default function HomeCard() {
    ...
    >
        <Image src="/images/home/hero/home-hero.jpg" width={1093} height={720} alt="" className="w-full object-cover rounded-lg absolute inset-0 size-full -z-10" />
        ...
        <div className="mt-auto p-4">
            <div className="flex items-center gap-2 mb-3.5">
                <div className="flex">
                    {Array.from({ length: 5 }).map((_, index) => (
                        <span key={index + randomNumber} className="block size-10 rounded-full -me-4 last-of-type:me-0 bg-white border border-gray-200 ring ring-white/10"></span>
                    ))}
                </div>
            ...
            <div className="text-sm">
                مطوّر عقاري متخصص في إنشاء المجمعات السكنية والمشاريع الاستثمارية الحديثة
            </div>
        </div>
    </article>
}
